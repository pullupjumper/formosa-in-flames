...
saveData.c.ground.mlrs.operationalAreas = config.c.ground.mlrs.OPAREAs
...
saveData.c.ground.mlrs.resupplyUnits = {
  ['IC8B0X-0HN7R5QOERV4D'] = {
    ...
    wpnDefault = config.c.ground.mlrs.wpnDefault,
    unitCount = 3,
    operationalArea = config.c.ground.mlrs.OPAREAs.Pingtan,
    reloadStartTime = nil,
  ...
  ['IC8B0X-0HNBRRE2PRRG9'] = {
    ...
    wpnDefault = config.c.ground.mlrs.wpnDefault,
    unitCount = 3,
    operationalArea = config.c.ground.mlrs.OPAREAs.Chinchew,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
...
saveData.c.ground.glcm.operationalAreas = config.c.ground.glcm.OPAREAs
...
saveData.c.ground.glcm.resupplyUnits = {
  ['IC8B0X-0HN7R5QOIVG88'] = {
    ...
    wpnDefault = config.c.ground.glcm.wpnDefault,
    unitCount = 8,
    operationalArea = config.c.ground.glcm.OPAREAs.Brigade635,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
...
saveData.c.ground.srbm.operationalAreas = config.c.ground.srbm.OPAREAs
...
saveData.c.ground.srbm.resupplyUnits = {
  ['IC8B0X-0HN7R5QOIVL7D'] = {
    ...
    unitCount = 9,
    operationalArea = config.c.ground.srbm.OPAREAs.Brigade615,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
  ...
  ['IC8B0X-0HN7R5QOIVLSG'] = {
    ...
    wpnDefault = config.c.ground.srbm.wpnDefault,
    unitCount = 9,
    operationalArea = config.c.ground.srbm.OPAREAs.Brigade614,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
  ...
  ['IC8B0X-0HN7R5QOIVMO1'] = {
    ...
    wpnDefault = config.c.ground.srbm.wpnDefault,
    unitCount = 9,
    operationalArea = config.c.ground.srbm.OPAREAs.Brigade636,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
  ...
  ['IC8B0X-0HN7R5QOIVOSN'] = {
    ...
    wpnDefault = config.c.ground.srbm.wpnDefault,
    unitCount = 9,
    operationalArea = config.c.ground.srbm.OPAREAs.Brigade616,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
  ...
  ['IC8B0X-0HN7R5QOIVPNC'] = {
    ...
    wpnDefault = config.c.ground.srbm.wpnDefault,
    unitCount = 9,
    operationalArea = config.c.ground.srbm.OPAREAs.Brigade613,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
  ...
  ['IC8B0X-0HN7R5QOIVQ6P'] = {
    ...
    wpnDefault = config.c.ground.srbm.wpnDefault,
    unitCount = 9,
    operationalArea = config.c.ground.srbm.OPAREAs.Brigade617,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
...
saveData.c.ground.mrbm.operationalAreas = config.c.ground.mrbm.OPAREAs
...
saveData.c.ground.mrbm.resupplyUnits = {
  ['IC8B0X-0HNCOR6HG2KF9'] = {
    ...
    unitCount = 6,
    operationalArea = config.c.ground.mrbm.OPAREAs.Brigade624,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
...
saveData.t.ground.mlrs.operationalAreas = config.t.ground.mlrs.OPAREAs
...
saveData.t.ground.mlrs.resupplyUnits = {
  ['IC8B0X-0HN7RT1I581BB'] = {
    ...
    wpnDefault = config.t.ground.mlrs.wpnDefault,
    unitCount = 2,
    operationalArea = config.t.ground.mlrs.OPAREAs.Pingzhen,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
...
saveData.t.ground.srbm.operationalAreas = config.t.ground.srbm.OPAREAs
...
saveData.t.ground.srbm.resupplyUnits = {
  ['IC8B0X-0HN7R5QOIVSFS'] = {
    ...
    wpnDefault = config.t.ground.srbm.wpnDefault,
    unitCount = 2,
    operationalArea = config.t.ground.srbm.OPAREAs.Dadu,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
...
saveData.t.ground.glcm.operationalAreas = config.t.ground.glcm.OPAREAs
...
saveData.t.ground.glcm.resupplyUnits = {
  ['IC8B0X-0HN7R5QOIVTHT'] = {
    ...
    unitCount = 3,
    operationalArea = config.t.ground.glcm.OPAREAs.Quanxi,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
  ...
  ['IC8B0X-0HN7R5QOIVUDC'] = {
    ...
    wpnDefault = config.t.ground.glcm.wpnDefault,
    unitCount = 3,
    operationalArea = config.t.ground.glcm.OPAREAs.Neipu,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
...
saveData.t.ground.ascm.operationalAreas = config.t.ground.ascm.OPAREAs
...
saveData.t.ground.ascm.resupplyUnits = {
  ['IC8B0X-0HN87KFOFSGUB'] = {
    ...
    unitCount = 2,
    operationalArea = config.t.ground.ascm.OPAREAs.Pingzhen,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
  ...
  ['IC8B0X-0HN9JFGVR07U5'] = {
    ...
    wpnDefault = config.t.ground.ascm.wpnDefault,
    unitCount = 2,
    operationalArea = config.t.ground.ascm.OPAREAs.Dong,
    reloadStartTime = nil,
    state = config.batteryState.STATIC,
...
saveData.t.ground.ascm.firingUnits = {
  ['IC8B0X-0HN87MOIE9C4U'] = {
    ...
    reloadStartTime = nil,
    state = config.batteryState.HIDE,
    operationalArea = config.t.ground.ascm.OPAREAs.Luzhu,
